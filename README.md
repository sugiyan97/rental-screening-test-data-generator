...
32 種類の `document_type` × 74 種類の variant に対応している。
...
- **会社の登記・財務** — 履歴事項全部証明書風（株主名簿付・公表商号あり）・決算書・複数期決算書・合計残高試算表・多言語（英語・中国語）決算書
...
多言語（英語・中国語）決算書・資金エビデンスのケースは、既存の日本語ケースと混在させず
